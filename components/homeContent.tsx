...
const HomeContent = (props: infProps) => {
  ...
  return (
    <>
      ...
      <br />
      Previously, I worked as product manager on <a href="https://www.microsoft.com/en-us/microsoft-viva/topics" target="_blank" rel="noopener noreferrer" >Viva Topics</a> at Microsoft, and <a href="https://aws.amazon.com/partners/saas-boost/" target="_blank" rel="noopener noreferrer">Boost</a> at AWS. <br />
