  ...
  return (
    <>
      ...
      <InfDiv {...props} pos={pos.terms} align='left'>
        <a className={styles.icons} href="mailto:oscarzhang@3279.com"  target="_blank" rel="noreferrer">       
         <FontAwesomeIcon icon={faEnvelope as IconProp}/>
        </a>

        <a className={styles.icons} href="https://www.linkedin.com/in/oscarzhangtc"  target="_blank" rel="noreferrer">
        <FontAwesomeIcon icon={faLinkedinIn as IconProp} />
        </a>

        <a className={styles.icons} href="https://github.com/oscarzhangtc"  target="_blank" rel="noreferrer">
